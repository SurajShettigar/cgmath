...
TEST_F(VectorTest, Vector2FunctionsLerp) {
    ASSERT_EQ(Vector2::lerp(vec2_def_init, vec2_scalar_init, 0.00001), vec2_scalar_init / 100000);
    ASSERT_EQ(Vector2::lerp(vec2_def_init, vec2_scalar_init, 0.5), vec2_scalar_init / 2.0);
    ASSERT_EQ(Vector2::lerp(vec2_def_init, vec2_scalar_init, 0.75), vec2_scalar_init / 1.333333333333333);
    ASSERT_EQ(Vector2::lerp(vec2_def_init, vec2_scalar_init, 1.0), vec2_scalar_init);
...
TEST_F(VectorTest, Vector3FunctionsNormalize) {
    Vector3 vec1 = Vector3{0.872871560943970, 0.436435780471985, 0.218217890235992};
...
TEST_F(VectorTest, Vector3FunctionsLerp) {
    ASSERT_EQ(Vector3::lerp(vec3_def_init, vec3_scalar_init, 0.00001), vec3_scalar_init / 100000);
    ASSERT_EQ(Vector3::lerp(vec3_def_init, vec3_scalar_init, 0.5), vec3_scalar_init / 2.0);
    ASSERT_EQ(Vector3::lerp(vec3_def_init, vec3_scalar_init, 0.75), vec3_scalar_init / 1.333333333333333);
    ASSERT_EQ(Vector3::lerp(vec3_def_init, vec3_scalar_init, 1.0), vec3_scalar_init);
...
TEST_F(VectorTest, Vector3FunctionsProject) {
    ...
    Vector3 vec3 = Vector3{-0.91304347826087, -0.152173913043478, -0.456521739130435};
...
TEST_F(VectorTest, Vector4Setters) {
    ...
    vec4_set.set(std::array<FLOAT, 4>{0.015625, 0.0078125, 0.00390625, 0.001953125});
...
TEST_F(VectorTest, Vector4FunctionsNormalize) {
    Vector4 vec1 = Vector4{0.867721831274625, 0.433860915637312, 0.216930457818656, 0.108465228909328};
...
TEST_F(VectorTest, Vector4FunctionsLerp) {
    ASSERT_EQ(Vector4::lerp(vec4_def_init, vec4_scalar_init, 0.00001), vec4_scalar_init / 100000);
    ASSERT_EQ(Vector4::lerp(vec4_def_init, vec4_scalar_init, 0.5), vec4_scalar_init / 2.0);
    ASSERT_EQ(Vector4::lerp(vec4_def_init, vec4_scalar_init, 0.75), vec4_scalar_init / 1.333333333333333);
    ASSERT_EQ(Vector4::lerp(vec4_def_init, vec4_scalar_init, 1.0), vec4_scalar_init);

    Vector4 vec1 = Vector4{0.00025, 0.0012, 1000000.000025, -10.0024232};
    Vector4 vec2 = Vector4{1.00333, 0.0013, 45084500.0000006533, -1.333333333333333};
    Vector4 vec3 = Vector4{0.501790, 0.001250, 23042250.00001282665, -5.667878266666667};
