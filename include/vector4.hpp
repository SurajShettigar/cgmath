...
namespace cgmath {
    ...
    public:
        ...
        explicit Vector4(const std::array<FLOAT, 4> &value)
                : m_value{value} {};

        // Copy
        Vector4(const Vector4 &vec4) {
            if (this != &vec4)
                m_value = vec4.m_value;
        }
        ...
        [[nodiscard]] inline FLOAT getW() const {
            return m_value[3];
        }
        ...
        friend Vector4 operator+(const Vector4 &lhs, const Vector4 &rhs) {
            return Vector4{lhs.m_value[0] + rhs.m_value[0],
        ...
        friend Vector4 operator*(const Vector4 &lhs, FLOAT rhs) {
            return Vector4{lhs.m_value[0] * rhs,
                           lhs.m_value[1] * rhs,
                           lhs.m_value[2] * rhs,
                           lhs.m_value[3] * rhs};
        }
        ...
        friend Vector4 operator/(FLOAT lhs, const Vector4 &rhs) {
            return Vector4{lhs / rhs.m_value[0],
                           lhs / rhs.m_value[1],
                           lhs / rhs.m_value[2],
                           lhs / rhs.m_value[3]};
        }
